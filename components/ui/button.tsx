  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary:"bg-sky-400 text-primary-foreground hover:bg-sky-400/90 border-skys500 border-b-4 active: border-b-0",
        primaryOutline:"bg-white text-sky-500 hover:bg-slate-100",
        secondary:"bg-pink-400 text-primary-foreground hover:bg-pink-400/90 border-pink-500 border-b-4 active: border-b-0",
        secondaryOutline:"bg-white text-pink-500 hover:bg-slate-100",
        ...
        sidebar:"bg-transparent text-slate-500 border-2 border-transaprent hover:bg-slate-100 transition-none",
        sidebarOutline:"bg-pink-500/15 text-pink-500 border-pink-300 border-2 hover:bg-pink-500/20 transition-none"
      },
      size: {
